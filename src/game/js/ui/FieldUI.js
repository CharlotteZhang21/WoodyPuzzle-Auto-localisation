...
FieldUI.prototype.placeDownloadText = function() {

    // var innerBox = .8;
    // var offsetHorizontal = .15;
    // var offsetVertical = .03;

    var cta = MainGame.autoLocalisation.getLocalisedCta();
    var downloadText = cta.text;
    var font = cta.font;
    var lang = cta.lang;
    ...
    var style = {
     ...
     this.downLoadText = new PIXI.Text(downloadText,style);
    ...
    var buttonWidth = this.download_btn.width;
    var buttonHeight = this.download_btn.height;
    ...
    while (textHeight > buttonHeight || textWidth > buttonWidth) {
        style.fontSize--;
        this.downLoadText.setStyle(style);
        textWidth = this.downLoadText.getBounds().width;
        textHeight = this.downLoadText.getBounds().height;
    }
